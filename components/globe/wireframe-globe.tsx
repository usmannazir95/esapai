    ...
    useEffect(() => {
        ...
        const pointInPolygon = (point: [number, number], polygon: number[][]): boolean => {
            ...
            for (let i = 0, j = polygon.length - 1; i < polygon.length; j = i++) {
                ...
                if (pi && pi.length >= 2 && pj && pj.length >= 2) {
        ...
        const render = () => {
            ...
            // Draw ocean (globe background) - removed fill for transparency
            context.beginPath()
            context.arc(containerWidth / 2, containerHeight / 2, currentScale, 0, 2 * Math.PI)
            context.strokeStyle = "rgba(19, 245, 132, 0.4)"
            ...
            if (landFeatures) {
                ...
                context.beginPath()
                path(graticule())
                context.strokeStyle = "rgba(19, 245, 132, 0.2)"
                ...
                context.strokeStyle = "rgba(19, 245, 132, 0.5)"
                ...
                allDots.forEach((dot) => {
                    ...
                    if (
                        ...
                        context.fillStyle = "rgba(19, 245, 132, 0.8)"
                        context.fill()
                    }
                })
            }
